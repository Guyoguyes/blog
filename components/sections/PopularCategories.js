...
const PopularCategories = ({categories}) => {
    ...
    return (
        <>
            <div className="mt-30">
                <h2 className="color-linear d-inline-block mb-10 wow animate__animated animate__fadeInUp">categories</h2>
                        ...
                        <div className="col-xl-2 col-lg-3 col-md-4 col-sm-4 col-6" key={i}>
                            <div className="card-style-2 hover-up hover-neon wow animate__animated animate__fadeIn" data-wow-delay={`${i/10}s`}>
                                <div className="card-image">
                                    <Link href="/blog-archive"><img src={`${item.imageUrl}`} alt="masomo guide" /></Link>
                                </div>
                                <div className="card-info">
                                    <Link className="color-gray-500" href="/blog-archive">{item.topic}</Link>
                                </div>
                            </div>
                        </div>
                    ))}
