                ...
                {posts.slice(1, 6).map((item, i) => (
                    <div className="card-list-posts wow animate__animated animate__fadeIn" key={i} data-wow-delay={`${i/10}s`}>
                        ...
                        <Link href={`/blog/${item.id}`}>
                            ...
                            <p className="color-gray-500">{item.topic}</p>
                            <div className="row mt-20">
                                ...
                                <div className="col-5 text-end"><span className="color-gray-700 text-sm calendar">{item.date}</span></div>
                            </div>
                        </div>
                    </div>
                ))}
