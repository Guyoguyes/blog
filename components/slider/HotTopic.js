            ...
            <div className="box-topics border-gray-800 bg-gray-850">
                <div className="row">
                    <div className="col-lg-2">
                        <h5 className="mb-15 color-white wow animate__animated animate__fadeInUp" data-wow-delay="0s">Top Topics</h5>
                                ...
                                >
                                    {categories.map((item, i) => (
                                        <SwiperSlide className="swiper-slide" key={i}>
                                            <div className="card-style-1 h-full"><Link href="/blog-archive">
                                                <div className="card-image h-full"><img src={item.imageUrl} className='h-full' alt="masomo Guide" />
                                                    <div className="card-info">
                                                        <div className="info-bottom">
                                                            <h6 className="color-white mb-5">{item.topic}</h6>
